...
export default {
    ...
    solar2lunar: function(_y, _m, _d) {
        ...
        //未传参  获得当天
        let objDate = y ? new Date(y, m, d) : new Date()
        // prettier-ignore
        let i, leap = 0, temp = 0
        //修正ymd参数
        m = m + 1
        ...
        //星期几 数字表示周几顺应天朝周一开始的惯例
        let nWeek = objDate.getDay() === 0 ? 7 : objDate.getDay()
        ...
        let firstNode = termNodeList && termNodeList[0] //返回当月「节」为几日开始
        let secondNode = termNodeList && termNodeList[1] //返回当月「节」为几日开始
        ...
        // 天干地支处理 月份不用+1，用_m
        let dayCyclical = Date.UTC(y, _m, 1, 0, 0, 0, 0) / 86400000 + 25567 + 10
     ...
     */
    lunar2solar: function(_y, _m, _d, _isLeapMonth) {
